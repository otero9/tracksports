 ...
 *
 */
public abstract class GoogleMapFragment extends SupportMapFragment implements UserInteractionListener, OnMapReadyCallback {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
		mapFragment = ((SupportMapFragment) this.getActivity().getSupportFragmentManager().findFragmentById(R.id.map_layout));
		if (mapFragment!=null) {
